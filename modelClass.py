...
class modelSolutions():
    ...
    def __init__(self, params = preferenceParams, specs = preferenceSpecs, method = 'Linear'):
    ...
    def solveProblem(self):
        ...
        if os.path.isfile('./HighAverse.pickle'):
            ...
            self.models['HighAverse'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./HighNeutral.pickle'):
            ...
            self.models['HighNeutral'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./LowAverse.pickle'):
            ...
            self.modelParams['ξₚ'] = 1 / 4500
            self.models['LowAverse'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./LowNeutral.pickle'):
            ...
            self.modelParams['ξₚ'] = 1 / 0.001
            self.models['LowNeutral'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./WeightedAverse.pickle'):
            ...
            self.modelParams['ξₚ'] = 1 / 4500
            self.models['WeightedAverse'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./WeightedNeutral.pickle'):
            ...
            self.modelParams['ξₚ'] = 1 / 0.001
            self.models['WeightedNeutral'] = preferenceModel(self.modelParams, self.solverSpecs)
        ...
        if os.path.isfile('./ximodels.pickle'):
            ...
            for ξ in xiList:
                if ξ == 1 / 0.001:
                    ...
                    self.xiModels[ξ] = preferenceModel(self.modelParams, self.solverSpecs)
