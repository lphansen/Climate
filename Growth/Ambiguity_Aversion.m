...
filename2 = [pwd, '/SCC_mat_Cumu_base_Growth'];
save(filename2)
...
out = solveCGNatural_1(stateSpace, model);
v0 = reshape(out,size(r_mat));
filename2 = [pwd, '/SCC_mat_Cumu_worst_Growth'];
save(filename2)
...
file2 = [pwd, '/SCC_mat_Cumu_base_Growth'];
...
file2 = [pwd, '/SCC_mat_Cumu_worst_Growth'];
...
file1 = [pwd, '/HJB_NonLinGrowth_Sims'];
...
Model1 = load(file1,'RE','R_1','R_2','R_3','R_4','R_5','R_6','R_7','R_8','R_9',...
    ...
    'pi_tilde_6_norm','pi_tilde_7_norm','pi_tilde_8_norm','pi_tilde_9_norm','r_mat','k_mat','t_mat',...
    'weight1','weight2','weight3','weight4','weight5','weight6','weight7','weight8','weight9',...
    'beta_f','theta','var_beta_f','beta_tilde_1','beta_tilde_2','beta_tilde_3','beta_tilde_4',...
