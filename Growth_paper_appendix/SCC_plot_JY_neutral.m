...
file2 = [pwd, '/SCC_mat_Cumu_base_GrowthNoAmb_1e9'];
...
file2 = [pwd, '/HJB_Growth_neutral_JY'];
...
file2 = [pwd, '/SCC_mat_Cumu_worst_GrowthNoAmb_1e9'];
...
file1 = [pwd, '/HJB_Growth_neutral_JY_Sims_JY'];
