                                     ...
                                     typename Dest::RealScalar& tol_error)
{
  ...
  RealScalar threshold = tol*tol*rhsNorm2; //original criteria
  // RealScalar threshold = tol*tol; // taking out denominator criteria
  // RealScalar threshold = tol*tol*(rhs.size()); // doing sqrt{average} criteria
  // std:: cout<<rhs.size();
