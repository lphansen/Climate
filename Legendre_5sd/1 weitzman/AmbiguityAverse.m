...
% load results
file2 = [pwd, '/SCC_mat_Cumu_base'];   % Feyman Kac base model
...
file1 = [pwd,'/HJB_NonLinPref_Cumu'];  % HJB
...
file2 = [pwd, '/SCC_mat_Cumu_worst'];  % Feyman Kac worst model
...
SCC2_V_d_tilt_func = griddedInterpolant(r_mat,t_mat,k_mat,SCC2_V_d_tilt_,'spline');
