...
s0 = '/HJB_NonLinPref_Cumu_big_vr';
filename = [pwd, s0];
save(filename); % save HJB solution
stop;
%% Step 3: simulation
% 
filename2 = [pwd,'/HJB_NonLinPref_Cumu_temp_2'];
...
figure('Position', [1 1 800 600])
plot(psi_0 * (new.j_hists2 .* new.hists2(:,2) ./ new.hists2(:,1)).^new.psi_1, 'LineWidth', 3)
hold on;
plot(newe.e_values ./ new.hists2(:,1), 'LineWidth', 3)
plot(psi_0 * (old.j_hists2 .* old.hists2(:,2) ./ old.hists2(:,1)).^old.psi_1, 'LineWidth', 3)
...
figure('Position', [1 1 800 600])
plot(new.j_hists2.^new.psi_1, 'LineWidth', 3)
hold on;
plot(old.j_hists2.^old.psi_1, 'LineWidth', 3)
legend(l1,l2);
