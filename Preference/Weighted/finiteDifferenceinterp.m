    ...
    if strcmp(scheme, 'central')
        if order == 1   % first order derivatives
            if dimension == 1
                ...
                res(2:end-1,:,:) = (1 ./ (dlt_multi(2:end) + dlt_multi(1:end-1))) .* ...
                    ((value(3:end,:,:) - value(2:end-1,:,:)) .* dlt_multi(1:end-1) ./ dlt_multi(2:end) + ...
                    (value(2:end-1,:,:) - value(1:end-2,:,:)) .* dlt_multi(2:end) ./ dlt_multi(1:end-1) );
